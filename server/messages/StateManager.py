...
class StateManager:
    ...
    async def broadcast_connected_users_list(self) -> None:
        ...
        count = {"type": "state", "property": "users", "values": {"count": self.connectionManager.get_client_count()}}
    ...
    async def update_dashboard_state(self):
        ...
        for dashboard_type in active_dashboards:
            ...
            await self.messageBus.broadcast_event_update_by_key(message=json.dumps(message), key=dashboard_type)
